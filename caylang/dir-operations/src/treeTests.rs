...
mod tests {
    ...
    fn test_get_children() {
        ...
        dataset.add_child(1, NodeData::new(PathBuf::from("file_a.txt"), NodeType::File));
        dataset.add_child(1, NodeData::new(PathBuf::from("file_b.txt"), NodeType::File));
        dataset.add_child(1, NodeData::new(PathBuf::from("file_c.txt"), NodeType::File));
        dataset.add_child(2, NodeData::new(PathBuf::from("file_d.txt"), NodeType::File));
        dataset.add_child(2, NodeData::new(PathBuf::from("file_e.txt"), NodeType::File));
        dataset.add_child(2, NodeData::new(PathBuf::from("file_f.txt"), NodeType::File));
        dataset.add_child(3, NodeData::new(PathBuf::from("file_g.txt"), NodeType::File));
        dataset.add_child(3, NodeData::new(PathBuf::from("file_h.txt"), NodeType::File));
        dataset.add_child(3, NodeData::new(PathBuf::from("file_i.txt"), NodeType::File));
