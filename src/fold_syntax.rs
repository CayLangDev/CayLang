...
// sha3: 0b4359f550820bb35e10d3d8a3d0d9152bfb50df498bedf202b523627265a122
use ast::{Token, Rule, RuleEntry, Path};
...
mod __parse__main {
    ...
    pub(crate) enum __Symbol<'input>
     {
        ...
        Variant2(Vec<Rule>),
        Variant3(Rule),
        Variant4(alloc::vec::Vec<Rule>),
        Variant5(Vec<RuleEntry>),
        Variant6(RuleEntry),
        Variant7(alloc::vec::Vec<RuleEntry>),
    }
    const __ACTION: &[i8] = &[
        // State 0
        0, 3, 0, 0, 0, 0,
    ...
    ) -> __state_machine::SimulatedReduce<__StateMachine<'input>>
    {
        match __reduce_index {
            ...
            2 => __state_machine::SimulatedReduce::Accept,
            3 => {
                __state_machine::SimulatedReduce::Reduce {
                    states_to_pop: 0,
    ...
    impl mainParser {
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<Vec<Rule>, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
    ...
    >(
        ...
        _: core::marker::PhantomData<(&'input ())>,
    ) -> Option<Result<Vec<Rule>,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
    ...
    >(
        __symbols: &mut alloc::vec::Vec<(usize,__Symbol<'input>,usize)>
    ) -> (usize, alloc::vec::Vec<RuleEntry>, usize)
     {
        match __symbols.pop() {
    ...
    {
        // Pattern = r#"\\s[-a-zA-Z0-9_/\\\\]+"# => ActionFn(4);
        let __sym0 = __pop_Variant0(__symbols);
        let __start = __sym0.0;
        let __end = __sym0.2;
    ...
    {
        // rule = "fold", Path, "{", rule_entries, "}" => ActionFn(2);
    ...
    {
        // rule_entries = rule_entry+ => ActionFn(18);
    ...
    {
        // rule_entry = Pattern, " => ", Path => ActionFn(6);
    ...
    {
        // rule_entry* = rule_entry+ => ActionFn(8);
        let __sym0 = __pop_Variant7(__symbols);
        let __start = __sym0.0;
        let __end = __sym0.2;
    ...
    {
        // rule_entry+ = rule_entry => ActionFn(13);
    ...
    {
        // rule_entry+ = rule_entry+, rule_entry => ActionFn(14);
        assert!(__symbols.len() >= 2);
...
mod __intern_token {
    ...
    pub fn new_builder() -> __lalrpop_util::lexer::MatcherBuilder {
        let __strs: &[(&str, bool)] = &[
            ("^([\\-/-9A-Z_a-z]+)", false),
            ("^((?:[\t-\r \u{85}\u{a0}\u{1680}\u{2000}-\u{200a}\u{2028}\u{2029}\u{202f}\u{205f}\u{3000}][\\-/-9A-Z\\\\_a-z]+))", false),
            ("^((?: => ))", false),
            ("^((?:fold))", false),
            ("^(\\{)", false),
            ("^(\\})", false),
...
>(
    ...
    (_, __3, _): (usize, Vec<RuleEntry>, usize),
...
>(
    input: &'input str,
    (_, __0, _): (usize, alloc::vec::Vec<RuleEntry>, usize),
) -> Vec<RuleEntry>
{
    __0
}
...
>(
    input: &'input str,
    (_, v, _): (usize, alloc::vec::Vec<RuleEntry>, usize),
) -> alloc::vec::Vec<RuleEntry>
{
    v
}
...
>(
    input: &'input str,
    __0: (usize, alloc::vec::Vec<RuleEntry>, usize),
) -> Vec<RuleEntry>
{
    let __start0 = __0.0;
    let __end0 = __0.2;
